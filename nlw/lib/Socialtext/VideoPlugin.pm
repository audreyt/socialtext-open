...
our %Services = (
    YouTube => {
        ...
        ssl_thumbnail => 1,
        # wmode=transparent allows dialogs and dropdowns to appear above
        # youtube videos
    ...
    Vimeo => {
        ...
        # <param name="wmode" value="transparent" allows dialogs and
        # dropdowns to appear above vimeo videos
