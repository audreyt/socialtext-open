// $Id: /mirror/openjsan/users/theory/Test.Simple/trunk/lib/Test/Harness/Browser.js 23138 2008-08-28T06:41:15.308449Z ingy  $
    ...
    location.href.replace(/[?#].+/, "") == parent.location.href.replace(/[?#].+/, ""))
{
    ...
    Test.Harness.Browser = function (opts) {
    ...
    Test.Harness.Browser.prototype._setupFrame = function () {
        ...
        if (this.w && this.h) {
            node.setAttribute("width", this.w);
            node.setAttribute("height", this.h);
        }
        else {
    ...
    Test.Harness.Browser.prototype.runTests = function () {
        ...
        var runner = function () {
            ...
            if (files[++ti]) {
                ...
                doRunTest(this, files[ti], buffer);
                runNext();
            } else {
    ...
    doRunTest = function (self, file, buffer) {
        if (/\.html$/.test(file)) {
            ...
            if (/MSIE|Opera|Safari|Konqueror/.test(navigator.userAgent)) {
                ...
                self.includes[self.includes.length-1] = file;
            ...
            for (var i = 0; i < self.includes.length - 1; i++) {
                el = doc.createElement("script");
                el.setAttribute("src", self.includes[i]);
                head.appendChild(el);
            }
            ...
            if (self.encoding()) el.charset = self.encoding();
